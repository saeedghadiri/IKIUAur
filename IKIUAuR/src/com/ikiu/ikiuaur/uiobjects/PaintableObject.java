...
public abstract class PaintableObject {
	...
	public PaintableObject(Typeface face) {
	...
	public void setFontSize(float size, Typeface face) {
	...
	public void paintText(Canvas canvas, float x, float y, CharSequence text,
			int start, int end) {
