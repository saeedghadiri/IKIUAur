...
/**
 * This class extends the View class and is designed draw markers on the View.
 * 
 */
public class AugmentedView extends View {
    ...
    public AugmentedView(Context context) {
        super(context);
        Log.v(TAG, "portrait              = "+ARActivity.ui_portrait);
        Log.v(TAG, "useCollisionDetection = "+ARActivity.useCollisionDetection);
        Log.v(TAG, "useSmoothing          = "+ARActivity.useDataSmoothing);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawing.compareAndSet(false, true)) {
            ...
            if (ARActivity.useCollisionDetection) 
